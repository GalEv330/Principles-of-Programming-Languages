...
// ========================================================
// Add classes to the L3 value definition 
export type Class = {
    tag: "Class";
    fields: VarDecl[];
    methods: Binding[];
...
// ========================================================
// Add objects to the L3 value definition 
export type Object = {
    tag: "Object";
    class: Class;
    fieldValues: Value[];
...
export const makeObject = (classVal: Class, fieldValues: Value[]): Object =>
    ({tag: "Object", class: classVal, fieldValues: fieldValues, env : makeEmptyEnv()});
export const makeObjectEnv = (classVal: Class, fieldValues: Value[], env: Env): Object =>
    ({tag: "Object", class: classVal, fieldValues: fieldValues, env: env});
...
export const classToString = (c: Class): string => `Class>`

export const objectToString = (o: Object): string => `Object>`
